package cool.wellwellwell.ddns.bot;

import cool.wellwellwell.ddns.contants.Global;
import cool.wellwellwell.ddns.handle.EventHandle;
 ...
 */
@Component
public class DdnsBot implements ApplicationRunner {
    private static final Logger logger = LoggerFactory.getLogger(DdnsBot.class);
